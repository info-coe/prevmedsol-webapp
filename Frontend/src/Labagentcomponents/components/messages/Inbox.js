...
// eslint-disable-next-line no-unused-vars
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        res.data.map((item) => {
          if (labagent.email === item.toemail) {
                ...
                if((index) === (clickedindex)){
                 return( <div key={index}>
                  ...
                  <p className="text-end">
                    <Link to='/labagentmessage' state={{ email: item.fromemail }}><button className="btn bodybutton text-white">Reply</button></Link>
                  </p>
                  </div>)
                }
              return null;
