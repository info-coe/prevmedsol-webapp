...
const LabagentSentmessage = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        res.data.map((item) => {
          if (labagent.email === item.fromemail) {
                ...
                if((index) === (clickedindex)){
                  return (
                    <div key={index}>
                      ...
                      <p><b>To : </b><Link to="/labagentmessage" state={{email : item.toemail}}>{item.toemail}</Link></p>
...
export default LabagentSentmessage;