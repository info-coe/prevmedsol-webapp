  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        const upcomingAppointments = res.data.data2.filter(
    ...
    <>
      ...
      <div className="d-flex ">
        ...
        <div className="col-sm-12 col-md-12 col-lg-10 p-0">
          ...
          <Link to="/patientupcomingappointment"><button className="btn btn-secondary text-white ms-4 m-1">Upcoming</button></Link>
          <Link to="/patientpreviousappointment"><button className="btn btn-light">Previous</button></Link>
          <div className="">
