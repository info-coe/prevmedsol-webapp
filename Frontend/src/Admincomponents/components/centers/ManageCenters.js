  ...
  return (
    ...
    <div className="d-flex ">
      ...
      <div className="col-sm-12 col-md-12 col-lg-10 p-0">
        ...
        <h4 className="mt-2 ms-2">Manage center</h4>
        ...
        <Csvclipboard/>
          ...
          <button
            ...
            className="btn  m-0"
          >
            <Link to="/addcenter" className="text-decoration-none text-dark">
        ...
        <div className="ps-2 pe-2 ps-lg-4 pe-lg-4 pb-4">
          ...
          <Pagination stateData={centers} pageSize={pageSize} setViewRowIndex={setViewRowIndex} currentPage={currentPage} setCurrentPage={setCurrentPage}/>
        </div>
        <hr></hr>
