    ...
    <>
      ...
      <div className="d-flex">
        ...
        <div className="col-sm-12 col-md-12 col-lg-10 p-0">
          ...
          <Link to="/upcomingappointments"><button className="btn btn-light ms-lg-4 ms-2 m-1">Upcoming</button></Link>
          <Link to="/previousappointments"><button className="btn btn-secondary text-white">Previous</button></Link>
